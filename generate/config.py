...
parser.add_argument('--n_ball', type=int, default=5, help="option for ablating on the number of balls")
parser.add_argument('--n_kp', type=int, default=5, help="the number of keypoint")
...
parser.add_argument('--dataf', default='no_force_no_relchange/')
parser.add_argument('--log', default='log')
parser.add_argument('--his', type=int, default=10)
parser.add_argument('--pred_roll','-p',type=int, default=5)
parser.add_argument('--num_message_passing','-m', type=int, default=2)
...
parser.add_argument('--edge_type_num', type=int, default=3)
...
def gen_args():
    ...
    if args.env == 'Ball':
        ...
        args.lim = [-1., 1., -1., 1.]
        args.prior = torch.FloatTensor(np.array([0.85, 0.15]))
